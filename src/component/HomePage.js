  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100 p-6 text-gray-800">
      ...
      <div className="mt-12 w-full px-6 text-center">
        <h2 className="text-3xl font-semibold text-blue-600 mb-6">Why Sprintify?</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="p-6 bg-white rounded-lg shadow-md">
            <FaListAlt className="text-blue-600 text-4xl mb-4" />
          ...
          <div className="p-6 bg-white rounded-lg shadow-md">
            <FaRegLightbulb className="text-blue-600 text-4xl mb-4" />
