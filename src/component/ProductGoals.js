...
const ProductGoalsTracker = () => {
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-2xl font-bold mb-4">Product Goals & Key Results Tracker</h1>
      ...
      <div className="flex items-center justify-center space-x-4 mb-4">
        ...
        <button
          ...
          className={`px-4 py-2 rounded ${viewMode === "organogram" ? "bg-blue-600 text-white" : "bg-gray-200 text-gray-800"}`}
        >
          Organogram View
        </button>
        <button
